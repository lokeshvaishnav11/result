...
const Goal = (props: any) => {
  ...
  const firstTableRows = rows.slice(0, 10)
  const secondTableRows = rows.slice(10)
                  ...
                  <table className='table coupon-table table table-bordered suspendwidth'>
                      <thead style={{ borderBottom: "0px" }}>
                         <tr style={{ background: '#2c3e50d9' }}>
                              <th className="box-4" style={{ color: 'white', paddingLeft: '7px', fontSize: '14px', fontWeight: 'bold' }}>
                                 Who Will Goal Next?
                               </th>
                         </tr>
                      </thead>
