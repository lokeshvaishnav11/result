...
const LayBackButtonUnlimited = (props: any) => {
  const { selectionid, lastOdds, liveMatchData, clsnamename, showLay = true ,selectedCard = null} = props;
  ...
  const hideSlugs = ["joker120","joker1"]; // add more slugs here
      ...
      dispatch(
        betPopup({
          ...
          betData: {
            ...
            selectionName: item.runnerName + (selectedCard ? ` - ${selectedCard}` : ""),
...
export default React.memo(LayBackButtonUnlimited);